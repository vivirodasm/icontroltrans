...
class Vehiculos extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fechaVtoContAfil' => 'Fecha Vto Cont Afil',
            'clase' => 'Clase',
