...
class Tbextractos extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['FUEC','idRuta', 'anioExtracto', 'idExtracto', 'idtercero', 'fechaExtracto', 'nroContrato', 'anioContrato', 'fechaInicio', 'fechaFin', 'ciudadOrigen', 'descripRuta', 'idvehiculo', 'vehVtoTO', 'vehVtoExtintor', 'vehVtoCDA', 'vehVtoSOAT', 'vehVtoRCC', 'vehVtoRCE', 'vehVtoBimestral', 'Aud_Usuario', 'Aud_Fecha'], 'required'],
            [['anioExtracto', 'idExtracto', 'nroContrato', 'anioContrato', 'ciudadOrigen', 'ciudadDestino', 'destinosVarios', 'idDestino', 'idRuta', 'rboFUEC', 'validoPDF', 'membreteEmp', 'anuladoFUEC', 'facturado', 'GrupoFUEC', 'Aud_Usuario', 'Aud_UsuarioEdit'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'consFUEC' => 'Cons Fuec',
            'FUEC' => 'Fuec',
            'anioExtracto' => 'Anio Extracto',
            'idExtracto' => 'Id Extracto',
            'antFUEC' => 'Ant Fuec',
            'idtercero' => 'Idtercero',
            'fechaExtracto' => 'Fecha Extracto',
            'resp_Contrato' => 'Resp Contrato',
            'cedResp_Contrato' => 'Ced Resp Contrato',
            'dirResp_Contrato' => 'Dir Resp Contrato',
            'telResp_Contrato' => 'Tel Resp Contrato',
            'convenioEmp' => 'Convenio Emp',
            ...
            'destinosVarios' => 'Destinos Varios',
            'idDestino' => 'Id Destino',
            'descripDestino' => 'Descrip Destino',
            'idRuta' => 'Id Ruta',
            'descripRuta' => 'Descrip Ruta',
            'idvehiculo' => 'Idvehiculo',
            'vehVtoTO' => 'Veh Vto To',
            'vehVtoExtintor' => 'Veh Vto Extintor',
            'vehVtoCDA' => 'Veh Vto Cda',
            'vehVtoSOAT' => 'Veh Vto Soat',
            'vehVtoRCC' => 'Veh Vto Rcc',
            'vehVtoRCE' => 'Veh Vto Rce',
            'vehVtoBimestral' => 'Veh Vto Bimestral',
            'vlrServicio' => 'Vlr Servicio',
            'vlrFUEC' => 'Vlr Fuec',
            'vlrCONTBFUEC' => 'Vlr Contbfuec',
