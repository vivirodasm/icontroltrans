...
class Terceros extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['idtercero', 'IdEmpresa', 'naturalez_tercero', 'nombrecompleto', 'idCenPob', 'idpaises', 'tipo_tercero', 'estado', 'Aud_Usuario', 'Aud_Fecha'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'naturalez_tercero' => 'Naturalez Tercero',
            ...
            'direccion_tercero' => 'Direccion Tercero',
            'tel_tercero' => 'Tel Tercero',
            'movil_tercero' => 'Movil Tercero',
            'idCenPob' => 'Ciudad',
            'idpaises' => 'Pais',
            'contacto_tercero' => 'Contacto Tercero',
            'ced_Contacto' => 'Ced Contacto',
            'dir_contacto' => 'Dir Contacto',
            'tel_contacto' => 'Tel Contacto',
            'mail_tercero' => 'Mail Tercero',
            'autData' => 'Aut Data',
            'tipo_tercero' => 'Tipo Tercero',
            'obs_tercero' => 'Obs Tercero',
            'estado' => 'Estado',
            'rutaRut' => 'Ruta Rut',
